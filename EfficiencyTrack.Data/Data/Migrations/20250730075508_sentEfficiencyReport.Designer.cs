...
namespace EfficiencyTrack.Data.Migrations
{
    ...
    [Migration("20250730075508_sentEfficiencyReport")]
    partial class sentEfficiencyReport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EfficiencyTrack.Data.Models.DailyEfficiency", b =>
                {
                    ...
                    b.Property<DateTime>("ComputedOn")
                        .HasColumnType("datetime2")
                        .HasComment("Timestamp when the efficiency was last calculated.");
                    ...
                    b.Property<decimal>("EfficiencyPercentage")
                        ...
                        .HasComment("Calculated efficiency as (total needed minutes based on operations / shift time) * 100.");
                    ...
                    b.Property<Guid>("ShiftId")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("The shift during which the employee worked.");

                    b.Property<decimal>("TotalNeededMinutes")
                        .HasColumnType("decimal(10,4)")
                        .HasComment("Total needed time .");
                    ...
                    b.ToTable("DailyEfficiencies", t =>
                        {
                            t.HasComment("Represents the daily efficiency of an employee, calculated automatically based on performed tasks and shift time.");
                        });
                });
            ...
            modelBuilder.Entity("EfficiencyTrack.Data.Models.Employee", b =>
                {
                    ...
                    b.Property<Guid?>("ShiftManagerUserId")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("Reference to the employee's shift manager (ApplicationUser).");
            ...
            modelBuilder.Entity("EfficiencyTrack.Data.Models.Entry", b =>
                {
                    ...
                    b.Property<decimal>("RequiredMinutes")
                        .HasColumnType("decimal(10,4)")
                        .HasComment("Theoretical required time for this operation.");
            ...
            modelBuilder.Entity("EfficiencyTrack.Data.Models.Feedback", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("EmployeeName")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
                        .HasComment("The full name of the employee providing the feedback.");
            ...
            modelBuilder.Entity("EfficiencyTrack.Data.Models.SentEfficiencyReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SentEfficiencyReports");
                });
            ...
            modelBuilder.Entity("EfficiencyTrack.Data.Models.Employee", b =>
                {
                    ...
                    b.HasOne("EfficiencyTrack.Data.Identity.ApplicationUser", "ShiftManagerUser")
                        .WithMany()
                        .HasForeignKey("ShiftManagerUserId");

                    b.Navigation("ApplicationUser");

                    b.Navigation("Department");

                    b.Navigation("ShiftManagerUser");
                });
